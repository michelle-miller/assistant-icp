...
# Installation checklist for Version 1.0.0.0
{: #install_1000}
...
**Attention**: If you downloaded the PPA file between 26 September 2018 and 4 October 2018, then you have version 1.0.0.0 of the service. This checklist applies to your version of the archive file. The process was simplified with the PPA file version 1.0.0.1 that was made available on 5 October 2018. Consider downloading the later version of the PPA file for a simpler installation experience. See [Installation checklist](install.html) for detailed installation instructions for version 1.0.0.1.
