...
- [Tutorial: Build a database-driven Slackbot ![External link icon](../../icons/launch-glyph.svg "External link icon")](https:///docs/tutorials/slack-chatbot-database-watson){: new_window}
- [Tutorial: Build a voice-enabled Android chatbot ![External link icon](../../icons/launch-glyph.svg "External link icon")](https:///docs/tutorials/android-watson-chatbot){: new_window}
